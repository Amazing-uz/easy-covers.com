...
define('CAMPAIGN_ID', "0306efae345db0f27687ecd1337a1a1a");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', '5309864802914f0729e65c9597c7ccf5');
define('MP_PARAM_NAME', '_boclk');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', '93a4470bc490246b83f07837b0c3e87d');
define('CHECK_MCPROXY_VALUE', 'c3ce799ce9d82f210daa4b210a3a7a389c3284e0a21e067737c346159887d349');
...
function getRandomWeightedUtmSource()
{
    $weighted_sources = [
        ...
        'tiktok'     => 7,    // 7%
        'youtube'    => 5,    // 5%
        ''           => 28    // 28% — пустой (ничего не добавляем)
    ];
